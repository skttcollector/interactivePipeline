...
class rigExport():
    def setup(self):
        ...
        self.time=int(mc.currentTime(q=1))
        oopsTest=mc.confirmDialog(t="HEADS UP!", m="THIS WILL EXPORT FRAME %s"%self.time, 
    ...
    def export(self, *args, **kwargs):
        ...
        preset="X:/Production/Code/Maya/Tools/PipelineTools/Python/Publishing/Cali.fbxexportpreset"
